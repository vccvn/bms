...
$(function() {
    ...
    function setThemeState() {
        // set theme type
        var defth = 'app-orange.css';
        if (typeof defaultThemeCSS != 'undefined') {
            defth = defaultThemeCSS;
        } else if (typeof defaultThemeColor != 'undefined') {
            defth = 'app-' + defaultThemeColor + '.css';
        }
        if (themeSettings.themeName) {
            $styleLink.attr('href', theme_css_url + '/app-' + themeSettings.themeName + '.css');
        } else {
            $styleLink.attr('href', theme_css_url + '/' + defth);
        }
