...
class AuthController extends ClientController
{
    ...
    public function __construct(UserRepository $userRepository, PasswordResetRepository $passwordResetRepository, ProfileRepository $profileRepository)
    {
    ...
    public function postRegister(RegisterRequest $req)
    {
        ...
        return redirect()->route('client.auth.login')->with('register','Đăng ký tài khoản thành công');
    }
    ...
    public function postLogin(LoginRequest $req)
    {
        ...
        return redirect()->route('client.auth.login')->withInput($req->all())->with('error','Sai tài khoản hoặc mật khẩu');
