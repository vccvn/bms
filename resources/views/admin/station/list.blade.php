            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Bến xe đầu cuối
                        <a href="{{route('admin.station.add')}}" class="btn btn-primary btn-sm rounded-s"> Thêm mới </a>
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-5 col-md-4 col-lg-5 col-xl-4">
            <div class="card card-primary">
                ...
                <div class="card-block">
                    <form id="menu-form" method="POST" action="{{route('admin.station.save')}}"  novalidate="true">
                        @csrf
...
<script>
    window.itemsInit = function() {
        Cube.items.init({
            urls:{
                delete_url: '{{route('admin.station.delete')}}'
            }
        });
    };
</script>
