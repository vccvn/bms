...
<article class="content items-list-page">
    ...
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Danh mục sản phẩm
                        <a href="{{route('admin.product.category.add')}}" class="btn btn-primary btn-sm rounded-s"> Thêm mới </a>
                    </h3>
    ...
    <div class="card items">
        ...
        <ul class="item-list striped list-body list-product-category">
            ...
            <?php
                $update_url = route('admin.product.category.update',['id'=>$item->id]);
            ?>
                    ...
                    <div class="item-col fixed item-col-same item-col-stats md">
                        <div class="item-actions">
                            <ul class="actions-list">
                                <li>
                                    <a href="{{$update_url}}" class="edit btn btn-sm btn-success">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="remove btn-delete-product-category btn btn-sm btn-danger" data-id="{{$item->id}}">
...
<script>
    window.product_categoriesInit = function() {
        Cube.product_categories.init({
            urls:{
                delete_url: '{{route('admin.product.category.delete')}}'
            }
        });
    };
</script>
