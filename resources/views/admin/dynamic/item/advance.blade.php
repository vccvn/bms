                    @if(in_array('advance', $required_fields))
                        <!-- link -->
                        <div class="card sameheight-item">
                            ...
                            <div class="product-links">
                                ...
                                <ul class="nav nav-tabs nav-tabs-bordered">
                                    ...
                                    @if ($hasProductLink)
                                        <li class="nav-item">
                                            <a href="#product-linked" class="nav-link {{!$t?'active':''}}" data-target="#product-linked" data-toggle="tab" aria-controls="product-linked" role="tab">
                                                Sản phẩm
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="tab-content tabs-bordered pb-3">
                                    ...
                                    @if ($hasProductLink)
                                        <div class="tab-pane fade in {{!$t?'active show':''}}" id="product-linked">
