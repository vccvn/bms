...
<article class="content items-list-page">
    ...
    <div class="card">
        <div class="card card-block sameheight-item">
            ...
            <form id="page-form" method="POST" action="{{$fmact}}" enctype="multipart/form-data" novalidate="true">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-7">
                        <h3 class="text-center">Thông tin {{isset($page)?'chi tiết':"trang"}}</h3>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="form-group keep-original">
                            <label for="keep_original" class="form-control-label "><input type="checkbox" name="keep_original" id="keep_original" {{old('keep_original', $model->keep_original)?"checked":''}}> Giữ nguyên kích thước</label>
                        </div>
                        <div class="form-group keep-original">
                            ...
                            <div class="product-links">
                                ...
                                <div class="tab-content tabs-bordered">
                                    ...
                                    <div class="tab-pane fade in" id="advanced-feature">
                                        ...
                                        @foreach(['with_sidebar', 'layout', 'display_content'] as $name)
                                            @php 
                                            $input = $inputs->get($name);
                                            if(!$input) continue;
                                            if(in_array($input->type,['radio','checkbox','checklist'])){
...
<script>
    window.slugsInit = function() {
        Cube.slugs.init({
            ...
            urls:{
                get: '{{route('admin.page.get-slug')}}',
                check: '{{route('admin.page.check-slug')}}'
            }
        });
    };
...
<script>
    startImageEditor("#page-form", "{{asset('contents/pages/'.(($inputs->feature_image && $inputs->feature_image->val())?$inputs->feature_image->value:'default.png'))}}");
