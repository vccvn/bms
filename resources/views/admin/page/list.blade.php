...
<article class="content items-list-page">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Trang
                        <a href="{{route('admin.page.add')}}" class="btn btn-primary btn-sm rounded-s"> Thêm mới </a>
                    </h3>
    ...
    <div class="card items">
        @include($__templates.'list-filter',['filter_list'=>['title'=>'Tiêu đề','views'=>'Lượt xem','created_at' => 'Thời gian']])
        @if($list->count()>0)
...
<script>
    window.pagesInit = function() {
        Cube.pages.init({
            urls:{
                delete_url: '{{route('admin.page.delete')}}'
            }
        });
    };
</script>
