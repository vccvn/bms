...
<article class="content items-list-page">
    ...
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Địa điểm hành trình
                        <a href="{{route('admin.place.add')}}" class="btn btn-primary btn-sm rounded-s"> Thêm mới </a>
                    </h3>
                </div>
            </div>
        </div>
                    ...
                    <li class="item" id="item-{{$item->id}}">
                        <div class="item-row">
                            ...
                            <div class="item-col fixed pull-left item-col-title item-col-same-md">
                                <div class="item-heading">Địa điểm</div>
                                <div>
        ...
        <div class="col-sm-5 col-md-4 col-lg-5 col-xl-4">
            <div class="card card-primary">
                ...
                <div class="card-block">
                    <form id="menu-form" method="POST" action="{{route('admin.place.save')}}"  novalidate="true">
                        @csrf
            ...
            <div class="card card-primary">
                ...
                <div class="card-block">
                    <form id="menu-form" method="POST" action="{{route('admin.station.import')}}" enctype="multipart/form-data"  novalidate="true">
                        @csrf
...
<script>
    window.itemsInit = function() {
        Cube.items.init({
            urls:{
                delete_url: '{{route('admin.place.delete')}}'
            }
        });
    };
</script>
