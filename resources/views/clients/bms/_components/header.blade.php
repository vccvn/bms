                ...
                <div class="navbar-top row p-0 pb-2 pt-2">
                    <div class="col-md-9 row contact-header">
                        <div class="col-md-3 p-0 phone">
                            <a href="tel:{{$pn = $siteinfo->phone_number('0945786960')}}" class="d-inline-flex">
                            ...
                            <span class="align-items-center d-gird pl-2 text-dark">{{$pn}}</span>
                            </a>
                        </div>
                        <div class="col-md-3 p-0 email">
                            <a href="mailto:{{$em = $siteinfo->email('doanln16@gmail.com')}}" class="d-inline-flex">
                            ...
                            <span class="align-items-center d-gird pl-2 text-dark">{{$em}}</span>
                            </a>
                        </div>
                        <div class="col-md-auto p-0 address">
                            <a href="{{$siteinfo->map_url('#')}}" class="d-inline-flex">
                            ...
                            <span class="align-items-center d-gird pl-2 text-dark">{{$siteinfo->office('Hàm Nghi, Mỹ Đình, Hà Nội')}}</span>
                            </a>
                        </div>
                    </div>
        ...
        <div class="container position-relative index">
            <div class="navbar-bottom row">
                <div class="navbar-logo col-sm-2">
                    <a href="{{route('home')}}">
                        <img src="{{$siteinfo->logo(theme_asset('images/logo.png'))}}">
                    </a>
                </div>
