                ...
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="video-image-box mar-bottom-40">
                            <figure class="image">
                                <img src="{{$welcome_page->getFeatureImage()}}" alt="">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="feature-block-two">
                            ...
                            <h4>{{$welcome_page->description}}</h4>
                            <div class="text">
                                {!! $welcome_page->content !!}
                            </div>
                            <div class="link"><a href="{{$about_page? $about_page->getViewUrl():'#'}}" class="theme-btn btn-style-two">Xem thêm</a></div>
                        </div>
                    </div>
                </div>
            </div>
