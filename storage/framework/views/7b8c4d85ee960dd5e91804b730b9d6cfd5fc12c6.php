<?php $__env->startSection('title', "Thẻ"); ?>
...
<article class="content items-list-page">
    ...
    <div class="title-search-block">
        ...
        <?php echo $__env->make($__templates.'list-search',['search_route'=>'admin.content.tag'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </div>
    <!-- list content -->
    <div class="row">
        <div class="col-12 col-md-4 col-lg-12 col-xl-4">
            <div class="card">
                <div class="card card-block sameheight-item">
                    ...
                    <form id="tag-form" method="POST" action="<?php echo e(route('admin.content.tag.save')); ?>"  novalidate="true">
                        <?php echo csrf_field(); ?>

                        <div class="form-group <?php echo e($errors->has('tag')?'has-error':''); ?>" id="form-group-tag">
                            ...
                            <?php echo $errors->has('tag')?'<span class="has-error">'.$errors->first('tag').'</span>':''; ?>
                    ...
                    <li class="item" id="item-<?php echo e($item->id); ?>">
                        <div class="item-row">
                            ...
                            <div class="item-col fixed pull-left item-col-same item-col-title">
                                ...
                                <div>
                                    <h4 class="item-title"> <a href="#" id="item-name-<?php echo e($item->id); ?>" class="btn-update-item" data-name="<?php echo e($item->keywords); ?>" data-id="<?php echo e($item->id); ?>"><?php echo e($item->keywords); ?></a> </h4>
                                </div>
                            </div>
                            ...
                            <div class="item-col fixed item-col-stats item-col-same-sm">
                                <div class="item-actions">
                                    <ul class="actions-list">
                                        <li>
                                            <a href="#" class="edit btn-update-item btn btn-sm btn-primary" data-id="<?php echo e($item->id); ?>">
...
<script>
    window.itemsInit = function() {
        Cube.items.init({
            urls:{
                delete_url: '<?php echo e(route('admin.content.tag.delete')); ?>'
            }
        });
    };
    ...
    window.tagsInit = function() {
        Cube.tags.init({
            urls:{
                update_url: '<?php echo e(route('admin.content.tag.update')); ?>',
