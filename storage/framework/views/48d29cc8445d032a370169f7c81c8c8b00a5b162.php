...
<?php $__env->startSection('content'); ?>
                ...
                <div class="column info-column col-md-5 col-sm-12 col-xs-12">
                	...
                	<div class="inner-box">
                        ...
                        <div class="contact-info">
                            <ul>
                                <li><span class="icon flaticon-placeholder"></span><?php echo e($siteinfo->office?$siteinfo->office:"Hà Đông, Hà Nội"); ?></li>
                                <li><span class="icon flaticon-envelope"></span><?php echo e($siteinfo->email); ?></li>
                                <li><span class="icon flaticon-phone-call"></span><?php echo e($siteinfo->phone_number); ?></li>
                            </ul>
                        </div>
                    </div>
    ...
    <?php if($siteinfo->google_map_lat && $siteinfo->google_map_lng): ?>
   	<!--Map Section-->
    <section class="map-section">
    	<div class="map-outer">
            ...
            <div class="map-canvas"
                data-zoom="13"
                data-lat="<?php echo e($siteinfo->google_map_lat); ?>"
                data-lng="<?php echo e($siteinfo->google_map_lng); ?>"			  
                data-type="roadmap"
                data-hue="#ffc400"
                data-title="<?php echo e($siteinfo->google_map_title); ?>"
                data-content="<?php echo e($siteinfo->google_map_contant); ?>"							
                style="height: 450px;">
            </div>
...
<script>
    window.onload = function () {
        ...
        GmapInit("<?php echo e(get_theme_url('images/icons/map-marker.png')); ?>");
...
<script src="<?php echo e(get_theme_url('js/map-script.js')); ?>"></script>
<!--End Google Map APi-->
<?php $__env->stopSection(); ?>
