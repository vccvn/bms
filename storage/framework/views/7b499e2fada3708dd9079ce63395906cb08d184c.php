...
<?php if($projects && count($prjs = $projects->getChildren(['@order_by'=>['created_at'=>'DESC'], '@limit'=>6]))): ?>
<?php
    $project_tags = [];
        ...
        <section class="projects gray_bg">
            <div class="auto-container">
                ...
                <ul class="post-filter text-center list-inline">
                    ...
                    <?php $__currentLoopData = $project_tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagname => $keywords): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    
                    <li data-filter=".<?php echo e($tagname); ?>">
                        <span><?php echo e($keywords); ?></span>
                    </li>
