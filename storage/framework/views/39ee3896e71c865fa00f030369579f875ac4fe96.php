 ...
 <div class="card">
    <div class="card card-block sameheight-item">
        ...
        <section class="break-point">
                                                ...
                                                <?php if($t): ?>
                                                    <div class="day-group">
                                                        <label class="item-check d-block day-check-block">
                                                            ...
                                                            value="<?php echo e($d->date); ?>" data-day="<?php echo e($d->day); ?>" <?php echo e($disable? 'disabled':''); ?>  <?php echo e((($disable && in_array($d->date, $forwards)) || in_array($d->date,$go_forward))? 'checked':''); ?>>
                                                            <span></span>
            ...
            <?php if($errors->has('forward_date')): ?>
                <div class="alert alert-danger text-center">
                    <?php echo e($errors->first('forward_date')); ?>
        ...
        <div class="check-all <?php echo e(!$days_available? 'disabled':''); ?>">
            <label class="item-check d-block">
                <input type="checkbox" name="check-_all_out_date" class="check-item checkbox" <?php echo e(!$days_available? 'disabled':''); ?>>
                <span></span>
        ...
        <?php for($i = 0; $i < $freq_trips; $i++): ?>
            ...
            <div class="mb-3">
                ...
                <?php if($route->type == 'direct' || ($route->type=='bus' && in_array(get_station_id(), [$route->from_id, $route->to_id]))): ?>
                    <div class="form-group row <?php echo e($st_time_error?'has-error':''); ?>" id="form-group-forward_trips-<?php echo e($i); ?>-started">
                        <label for="forward_trips-<?php echo e($i); ?>-started" class="form-control-label col-sm-4 col-md-12 col-lg-4 col-xl-3" id="label-for-forward_trips<?php echo e($i); ?>-started">Xuất bến</label>
                        <div class="input-datetime-wrapper col-sm-8 col-md-12 col-lg-8 col-xl-9">
                            <input type="hidden" name="forward_trips[<?php echo e($i); ?>][old_started]" value="<?php echo e($old_started); ?>">
                            
                            <div class="row">
                                <div class="col-4">
                                    <select name="forward_trips[<?php echo e($i); ?>][st_hour]" class="form-control">
                                ...
                                <div class="col-4">
                                    <select name="forward_trips[<?php echo e($i); ?>][st_minute]" class="form-control">
                            ...
                            <div class="errors">
                                <?php if($st_time_error): ?>
                                    <span class="has-error">
                                        <?php echo e(session('time_start')?session('time_start'):"Thời gian xuất phát không hợp lệ"); ?>
                    ...
                    <div class="form-group row <?php echo e($et_time_error?'has-error':''); ?>" id="form-group-forward_trips-<?php echo e($i); ?>-arrived">
                        <label for="forward_trips-<?php echo e($i); ?>-arrived_at" class="form-control-label col-sm-4 col-md-12 col-lg-4 col-xl-3" id="label-for-forward_trips<?php echo e($i); ?>-started_at">Đến nơi sau...</label>
                        <div class="input-datetime-wrapper col-sm-8 col-md-12 col-lg-8 col-xl-9">
                            <input type="hidden" name="forward_trips[<?php echo e($i); ?>][et_time]" value="<?php echo e($et_time); ?>">
                            
                            <div class="row">
                                <div class="col-4 ml-auto">
                                    <select name="forward_trips[<?php echo e($i); ?>][et_day]" class="form-control">
                                        <?php for($j = 0; $j < 31; $j++): ?>
                                ...
                                <div class="col-4">
                                    <select name="forward_trips[<?php echo e($i); ?>][et_hour]" class="form-control">
                                        <option value="">Giờ</option>
                                        <?php for($j = 0; $j < 24; $j++): ?>
                                ...
                                <div class="col-4">
                                    <select name="forward_trips[<?php echo e($i); ?>][et_minute]" class="form-control">
                                        <option value="">Phút</option>
                                        <?php for($j = 0; $j < 60; $j+=5): ?>
                ...
                <?php else: ?>
                    ...
                    <div class="form-group row <?php echo e($ar_time_error?'has-error':''); ?>" id="form-group-forward_trips-<?php echo e($i); ?>-started">
                        <label for="forward_trips-<?php echo e($i); ?>-arrived" class="form-control-label col-sm-4 col-md-12 col-lg-4 col-xl-3" id="label-for-forward_trips<?php echo e($i); ?>-started">Vào bến</label>
                        <div class="input-datetime-wrapper col-sm-8 col-md-12 col-lg-8 col-xl-9">
                            <input type="hidden" name="forward_trips[<?php echo e($i); ?>][old_arrived]" value="<?php echo e($old_arrived); ?>">
                            
                            <div class="row">
                                <div class="col-4 auto">
                                    <select name="forward_trips[<?php echo e($i); ?>][ar_hour]" class="form-control">
                                        <option value="">Giờ</option>
                                        <?php for($j = 0; $j < 24; $j++): ?>
                                ...
                                <div class="col-4">
                                    <select name="forward_trips[<?php echo e($i); ?>][ar_minute]" class="form-control">
                                        <option value="">Phút</option>
                                        <?php for($j = 0; $j < 60; $j+=5): ?>
