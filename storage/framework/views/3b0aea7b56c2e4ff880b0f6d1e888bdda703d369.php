            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Địa điểm hành trình
                        <a href="<?php echo e(route('admin.place.add')); ?>" class="btn btn-primary btn-sm rounded-s"> Thêm mới </a>
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-5 col-md-4 col-lg-5 col-xl-4">
            <div class="card card-primary">
                ...
                <div class="card-block">
                    <form id="menu-form" method="POST" action="<?php echo e(route('admin.place.save')); ?>"  novalidate="true">
                        <?php echo csrf_field(); ?>
...
<script>
    window.itemsInit = function() {
        Cube.items.init({
            urls:{
                delete_url: '<?php echo e(route('admin.place.delete')); ?>'
            }
        });
    };
</script>
