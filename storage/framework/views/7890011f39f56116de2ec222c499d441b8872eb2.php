            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Tỉnh thành 
                        <a href="<?php echo e(route('admin.province.add')); ?>" class="btn btn-primary btn-sm rounded-s"> Thêm mới </a>
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-5 col-md-4 col-lg-5 col-xl-4">
            <div class="card card-primary">
                ...
                <div class="card-block">
                    <form id="menu-form" method="POST" action="<?php echo e(route('admin.province.save')); ?>"  novalidate="true">
                        <?php echo csrf_field(); ?>
            ...
            <div class="card card-primary">
                ...
                <div class="card-block">
                    <form id="menu-form" method="POST" action="<?php echo e(route('admin.province.import')); ?>" enctype="multipart/form-data"  novalidate="true">
                        <?php echo csrf_field(); ?>
...
<script>
    window.itemsInit = function() {
        Cube.items.init({
            urls:{
                delete_url: '<?php echo e(route('admin.province.delete')); ?>'
            }
        });
    };
</script>
