                ...
                <div class="container position-relative index">
                    <div class="navbar-bottom row">
                        <div class="navbar-logo col-md-3 ">
                            <a href="#"><img src="<?php echo e(get_theme_url('images/logo.png')); ?>"></a>
                        </div>
                        <div class="navbar-menu col-md-8 d-gird align-items-center">
                            <nav class="navbar navbar-expand-sm">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link text-white active" href="<?php echo e(route('client.home')); ?>">Trang chủ</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-white" href="<?php echo e(route('client.about')); ?>">Giới thiệu</a>
                                    </li>
                                    <!-- Dropdown -->
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link text-white" href="<?php echo e(route('client.news')); ?>">Tin tức</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link text-white" href="<?php echo e(route('client.lien-he')); ?>">Liên hệ</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group d-unset">
                                                ...
                                                <select class="form-control">
                                                    <?php $__currentLoopData = $stations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
