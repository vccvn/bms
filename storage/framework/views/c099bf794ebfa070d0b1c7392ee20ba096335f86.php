...
<head>
    ...
    <?php echo $__env->make('admin._templates.css', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<body>
    ...
    <?php echo $__env->make($__templates.'clean-js', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
