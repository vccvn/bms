                            ...
                            <div class="product-links">
                                ...
                                <div class="tab-content tabs-bordered">
                                    ...
                                    <div class="tab-pane fade in" id="advanced-feature">
                                            ...
                                            <div class="inputs">
                                                <?php $__currentLoopData = $props; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <label class="d-inline-block ml-3">
                                                        <input type="checkbox" name="required_fields[]" value="<?php echo e($p); ?>" <?php echo e((in_array($p, $required_fields) || old('required_fields.'.$p))?'checked="true" ':''); ?> /> <?php echo e($p); ?>
                                        ...
                                        <?php $__currentLoopData = ['post_type','allow_comment','use_category', 'children_props']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php 
                                            $input = $inputs->get($name);
                                            if(!$input) continue;
                                            if(in_array($input->type,['radio','checkbox','checklist'])){
