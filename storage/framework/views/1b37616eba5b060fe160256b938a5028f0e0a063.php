<?php $__env->startSection('title', "Mục nâng cao"); ?>
...
<article class="content items-list-page">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Mục nâng cao
                        <a href="<?php echo e(route('admin.dynamic.add')); ?>" class="btn btn-primary btn-sm rounded-s"> Thêm mới </a>
                    </h3>
                </div>
            </div>
        </div>
    ...
    <div class="card items">
        <?php echo $__env->make($__templates.'list-filter',['filter_list'=>['title'=>'Tên mục','views'=>'Lượt xem','created_at' => 'Thời gian']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php if(count($list)>0): ?>
...
<script>
    window.pagesInit = function() {
        Cube.pages.init({
            urls:{
                delete_url: '<?php echo e(route('admin.dynamic.delete')); ?>'
            }
        });
    };
</script>
