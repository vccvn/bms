...
<article class="content items-list-page">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Sản phẩm
                        <a href="<?php echo e(route('admin.product.add')); ?>" class="btn btn-primary btn-sm rounded-s"> Thêm mới </a>
                    </h3>
    ...
    <div class="card items">
        <?php echo $__env->make($__templates.'list-filter',['filter_list'=>['name'=>'Tên sản phẩm','created_at' => 'Thời gian']], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php if($list->count()>0): ?>
        ...
        <ul class="item-list striped list-body list-product">
            ...
            <li class="item" id="product-item-<?php echo e($item->id); ?>">
                <div class="item-row">
                    <div class="item-col fixed item-col-check">
                        <label class="item-check">
                            <input type="checkbox" name="products[<?php echo e($loop->index); ?>][id]" class="check-item checkbox" value="<?php echo e($item->id); ?>">
                            <span></span>
                        </label>
                    </div>
                    ...
                    <div class="item-col fixed pull-left item-col-title">
                        ...
                        <div>
                            <a href="<?php echo e($item->getUpdateUrl()); ?>" class="">
                                <h4 class="item-title" id="product-name-<?php echo e($item->id); ?>"> <?php echo e($item->name); ?> </h4>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="item-col fixed item-col-same-md item-col-stats">
                        <div class="item-actions">
                            <ul class="actions-list">
                                ...
                                <li>
                                    <a href="#" class="remove btn-delete-product btn btn-sm btn-danger-outline" data-id="<?php echo e($item->id); ?>">
...
<script>
    window.productsInit = function() {
        Cube.products.init({
            urls:{
                delete_url: '<?php echo e(route('admin.product.delete')); ?>'
            }
        });
    };
</script>
