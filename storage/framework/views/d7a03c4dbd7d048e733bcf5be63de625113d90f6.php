...
->buttonAction(function($submit,$cancel,$btngroup) use ($ft,$fm){
    ...
    elseif($ft=='login'){
        ...
        $text->append(HTML::a(route('register'),'Đăng ký mới'));
    }
...
<?php $__env->startSection('content'); ?>
    <p class="text-center"><?php echo ($ft=='forgot')?"Đặt lại mật khẩu":(($ft=='login')?"Vui lòng đăng nhập để tiếp tục":(($ft=='reset')?"Đặt lại mật khẩu":"Đăng ký tài khoản mới")); ?></p>
    <?php echo ($ft=='forgot')?'<p class="text-muted text-center">
